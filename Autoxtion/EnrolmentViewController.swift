...
class EnrolmentViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let topBorderourautoRenewalView = CALayer()
        topBorderourautoRenewalView.backgroundColor = bottomBorderColorDark.CGColor
        topBorderourautoRenewalView.frame = CGRectMake(-20.0, 0, 800, 1)
        self.autoRenewalView.layer .addSublayer(topBorderourautoRenewalView)
        
        let bottomBorderautoRenewalView = CALayer()
        bottomBorderautoRenewalView.borderColor = UIColor.grayColor().CGColor
        bottomBorderautoRenewalView.frame = CGRectMake(0.0, self.autoRenewalView.frame.size.height-1, 800, 1.0)
        bottomBorderautoRenewalView.backgroundColor = bottomBorderColorDark.CGColor
        self.autoRenewalView.layer .addSublayer(bottomBorderautoRenewalView)
    ...
    @IBAction func aboutAutoxtionButtonTapped(sender: AnyObject) {
